...
--------------------------------------------------------------------------*/
void __attribute__((long_call, naked, no_return)) resetMemory2_ARM9 (void) 
{
 	register int i;
...
//	VRAM_C_CR = 0;
	...
	*((vu32*)0x02FFFE24) = (u32)0x02FFFE04;		// Set ARM9 Loop address
	...
	asm volatile("mov pc, %0" :: "r"(0x2FFFE04));
	while(1);
}
...
--------------------------------------------------------------------------*/
void __attribute__((long_call, noreturn, naked)) startBinary_ARM9 (void)
{
	REG_IME=0;
	REG_EXMEMCNT = 0xE880;
